...
const Footer = () => {
  return (
    <div className="footer-container">
      <div className="info">
        <h4 className='text-danger mb-3'><img width='100px' src={logo} alt="" /> Nath ToYs</h4>
        <p>
          Nunc consequat interdum varius sit amet mattis. Ac tortor vitae purus
          faucibus ornare.Nunc consequat interdum varius sit amet mattis. Ac tortor vitae purus
          faucibus ornare.Nunc consequat interdum varius sit amet mattis. Ac tortor vitae purus
          faucibus ornare.
        </p>
      </div>
...
</svg> 4005, Silver business point, 
Bangladesh 
<button className='btn'>View in map</button>
        </div>
        <div>
        <svg xmlns="http://www.w3.org/2000/svg" className="h-1 w-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
